...
main = tkinter.Tk()
main.title("Brain Tumour Image Segmentation Using Deep Networks") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='Brain Tumour Image Segmentation Using Deep Networks')
